			...
			try {
				...
				if (!usi_app.suppress_page) {
					...
					if (!usi_cookies.value_exists("usi_active_cart") && usi_app.is_creative_flow_page) {
						...
						} else if (usi_app.is_enabled && (usi_app.get_user_status("user").status == "guest" || usi_app.get_user_status("user").isActive == "false") && (/.shutterstock.com\/image-generated|.shutterstock.com\/ai-image-generator|.shutterstock.com\/generate/i).test(location.href) && (language_key == "_english")) {
